...
if (getComputedStyle(markerElement).getPropertyValue('background-image') === 'none') {
  ...
  /////  
    ...
    function updateCashFlow(event) {
      const purchasePrice = parseInt(inputPurchasePrice.value.replace(/[^0-9.-]+/g,""));
      const arv = parseInt(inputArv.value.replace(/[^0-9.-]+/g,""));
      ...
      const closingCosts = parseInt(inputClosingCosts.value.replace(/[^0-9.-]+/g,""));
      const rehabCosts = parseInt(inputRehabCosts.value.replace(/[^0-9.-]+/g,""));
      ...
      const refinanceClosingCosts = parseInt(inputRefinanceClosingCosts.value.replace(/[^0-9.-]+/g,""));
      const rentalIncome = parseInt(inputRentalIncome.value.replace(/[^0-9.-]+/g,""));
      const otherIncome = parseInt(inputOtherIncome.value.replace(/[^0-9.-]+/g,""));
      ...
      const utilities = parseInt(inputUtilities.value.replace(/[^0-9.-]+/g,""));
      const hoa = parseInt(inputHoa.value.replace(/[^0-9.-]+/g,""));
      const propertyTaxRate = parseFloat(inputPropertyTaxRate.value);
      const propertyInsurance = parseInt(inputPropertyInsurance.value.replace(/[^0-9.-]+/g,""));
      const otherExpenses = parseInt(inputOtherExpenses.value.replace(/[^0-9.-]+/g,""));
